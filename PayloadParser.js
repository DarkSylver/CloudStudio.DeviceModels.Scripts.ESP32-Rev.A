...
var mensaje = payload.asJSON();
var temperaturaSensor = device.endpoints.byType(endpointType.temperatureSensor);
var humedadSensor = device.endpoints.byType(endpointType);
/*  
